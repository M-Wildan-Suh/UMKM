        ...
        <div class=" min-h-screen pt-6 relative space-y-4 bg-[#FCC737]">
            ...
            <div class=" w-full sticky bottom-0 py-2 px-4 sm:px-8 z-30 rounded-b-md">
                <div class="grid grid-cols-2 gap-2 w-full max-w-[640px] mx-auto">
                    <a href="{{route('home')}}">
                        <button
                            class=" text-base w-full py-2 border rounded-md text-white bg-[#F26B0F] border-[#F26B0F] hover:text-white hover:bg-[#16424b] hover:border-[#16424b] hover:font-black duration-300 relative shadow-md shadow-black/20">
                    ...
                    <a href="https://wa.me/{{ $no_tlp ?? '' }}">
                        <button
                            class=" text-base w-full py-2 border rounded-md bg-[#F26B0F] text-white border-[#F26B0F] hover:text-white hover:bg-[#1f7675] hover:border-[#1f7675] hover:font-black duration-300 relative shadow-md shadow-black/20">
                            <div class=" absolute w-5 aspect-square top-1.5 sm:top-2.5 left-2">
