        ...
        <div class=" min-h-screen pt-6 relative space-y-4 bg-gradient-to-b from-[#cdeef5] to-[#B1F0F7]">
            ...
            <div class=" w-full sticky bottom-0 py-2 px-4 sm:px-8 z-30 rounded-b-md">
                <div class="grid grid-cols-2 gap-2 w-full max-w-[640px] mx-auto">
                    <a href="{{route('home')}}">
                        <button
                            class=" text-base w-full py-2 border rounded-md text-white bg-[#ffd864] border-[#dbb84d] hover:text-white hover:bg-[#e6c154] hover:border-[#e6c154] hover:font-black duration-300 relative shadow-md shadow-black/20">
                    ...
                    <a href="https://wa.me/{{ $no_tlp ?? '' }}">
                        <button
                            class=" text-base w-full py-2 border rounded-md bg-[#81BFDA] text-white border-[#619ab3] hover:text-white hover:bg-[#629bb3] hover:border-[#629bb3] hover:font-black duration-300 relative shadow-md shadow-black/20">
                            <div class=" absolute w-5 aspect-square top-1.5 sm:top-2.5 left-2">
