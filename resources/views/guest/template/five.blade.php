        ...
        <div class=" min-h-screen pt-6 sm:pt-12 relative space-y-6 bg-gradient-to-b from-blue-500 to-purple-600">
            ...
            <div class=" w-full sticky bottom-0 py-2 px-4 sm:px-8 z-30 rounded-b-md">
                <div class="grid grid-cols-2 gap-2 w-full max-w-[640px] mx-auto">
                    <a href="{{route('home')}}">
                        <button
                            class=" text-base w-full py-2 border rounded-md text-white bg-blue-500 border-blue-500 hover:text-white hover:bg-[#16424b] hover:border-[#16424b] hover:font-black duration-300 relative shadow-md shadow-black/20">
                    ...
                    <a href="https://wa.me/{{ $no_tlp ?? '' }}">
                        <button
                            class=" text-base w-full py-2 border rounded-md bg-purple-500 text-white border-purple-500 hover:text-white hover:bg-[#1f7675] hover:border-[#1f7675] hover:font-black duration-300 relative shadow-md shadow-black/20">
                            <div class=" absolute w-5 aspect-square top-2.5 left-2">
