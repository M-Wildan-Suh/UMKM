    ...
    <div class=" space-y-6">
        ...
        <div class=" w-full sticky bottom-0 bg-white/30 py-2 px-4 sm:px-8 backdrop-blur-md z-30 rounded-b-md">
            <div class="grid grid-cols-2 gap-2 w-full max-w-[640px] mx-auto">
                <a href="{{route('home')}}">
                    <button
                        class=" text-base w-full py-2 border rounded-md text-white bg-[#03497d] border-[#03497D] hover:text-white hover:bg-[#dd5bb8] hover:border-[#dd5bb8] hover:font-black duration-300 relative">
                ...
                <a href="https://wa.me/{{ $no_tlp ?? '' }}">
                    <button
                        class=" text-base w-full py-2 border rounded-md bg-[#4b91b1] text-white border-[#4b91b1] hover:text-white hover:bg-[#d2ab41] hover:border-[#d2ab41] hover:font-black duration-300 relative">
                        <div class=" absolute w-5 aspect-square top-1.5 sm:top-2.5 left-2">
